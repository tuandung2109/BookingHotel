<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DichVu.aspx.cs" Inherits="ThuLamBaiTapLon2.WebForm5" %>
...
<head runat="server">
    <title>Dịch vụ</title>
    <link href="Style3/dichvu.css" rel="stylesheet" />
</head>
<body>
    <div class="header">
        ...
        <div class="header_mid">
            <a href="Trangchu.aspx">
                <img width="200" height="80" src="image/logo.png" title="Phòng">
            </a>
        </div>
    ...
    <div class="up">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>TRANG CHỦ</strong></a> / <a href="DichVu.aspx"><strong>DỊCH VỤ</strong></a>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="sidebar_two">
            <div class="sanpham">
                <asp:ListView ID="dichvu" runat="server">
                    <ItemTemplate>
